export const translations = {
  en: {
    ...
    softwareProduction: 'Software Development, Metropolia',
    itWeb: 'IT & Web',
    ...
    webDeveloper: 'Web-ohjelmistokehittäjä',
    helsinki: 'Helsinki, Suomi',
    bengStudent: 'Tekniikan alan insinööriopiskelija',
    ...
    collaboration: 'Etsin web-kehittäjän rooleja. Ota rohkeasti yhteyttä yhteistyöstä tai kysymyksistä!',
